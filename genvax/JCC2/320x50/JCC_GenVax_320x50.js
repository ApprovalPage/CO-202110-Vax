...
if (reversed == null) { reversed = false; }
	...
	// type bkgd
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#79863C").s().p("AtOD6IAAnzIaeAAIAAHzg");
	this.shape_1.setTransform(234.75,25);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#79863C").s().p("A44D6IAAnzMAxxAAAIAAHzg");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/JCC_GenVax_320x50_atlas_1.jpg?1634175277040", id:"JCC_GenVax_320x50_atlas_1"}
	],
	preloads: []
};
