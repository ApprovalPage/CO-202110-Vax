...
lib.ssMetadata = [
		{name:"JCC_GenVax_300x50_atlas_1", frames: [[0,0,600,355]]}
];
...
(lib.CuteKid250OMNI = function() {
	this.initialize(ss["JCC_GenVax_300x50_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.JCC_GenVax_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_3.setTransform(244.65,32.55,0.1747,0.1747,0,0,0,267.1,126.2);
	...
	this.instance_4.setTransform(144.55,31,0.7663,0.7663,0,0,0,-0.9,0);
	...
	// type bkgd
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#79863C").s().p("AsfD6IAAnzIY/AAIAAHzg");
	this.shape_1.setTransform(220,25);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#79863C").s().p("A3YD6IAAnzMAuxAAAIAAHzg");
...
p.nominalBounds = new cjs.Rectangle(147.5,5.1,223.5,58.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/JCC_GenVax_300x50_atlas_1.jpg?1634175283539", id:"JCC_GenVax_300x50_atlas_1"}
	],
	preloads: []
};
